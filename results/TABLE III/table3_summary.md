...
### Parameter: Number of Subtasks in a MTOP ($n_{\mathrm{sub}}$) - Sensitivity Analysis
...
### Parameter: Maximum Dimension Ratio ($d_{\max}$) - Sensitivity Analysis
...
### Parameter: Number of Subtasks in a MTOP ($n_{\mathrm{sub}}$) - Performance Breakdown
...
### Parameter: Maximum Dimension Ratio ($d_{\max}$) - Performance Breakdown

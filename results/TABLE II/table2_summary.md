...
This table presents the average rankings across the tested CEC2013 LSGO benchmarks (F1, F2, F4, F5, F9) and Wilcoxon rank-sum test outcomes (`+/≈/-`) comparing `CCMTO-MTES-DAKG` against each baseline algorithm at significance level $\alpha = 0.05$.

| Algorithm                  | CEC2013 (+) | CEC2013 (≈) | CEC2013 (-) | Average Ranking |
| :------------------------- | :---------: | :---------: | :---------: | :-------------: |
| **CCMTO-MTES-DAKG (Ours)** |     \       |     \       |     \       |    **1.40**     |
...
Statistical metrics (Mean Error ± Std Error) across 10 independent runs (best values in **bold**):

| Function | **CCMTO-MTES-DAKG (Ours)** |       CMAES-EDG       |       DECC-ERDG       |       GTDE        |       SDLSO       |
| :------- | :------------------------: | :-------------------: | :-------------------: | :---------------: | :---------------: |
